...
public class SampleRecyclableItem extends Recyclable<SampleModel> {
    private ItemSampleBinding binding;

    public SampleRecyclableItem(@NonNull Listener listener, ActionListener<SampleModel> actionListener) {
